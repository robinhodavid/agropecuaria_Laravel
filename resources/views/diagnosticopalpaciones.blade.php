	...
	<div class="row">
		<div class="col-5 card-especie mr-3 border-style"> <!--Form y Validación-->
			<div class="row row-list border-bottom">
				<div class="col title-header">Registro de Diagnósticos de Palpaciones</div>
			</div>
			 @if(session('msj'))
			...
			<div class="row my-4">
				<div class="form-registro">
					<form action="{{ route ('diagnostico_palpaciones.crear', $finca->id_finca) }}" method="POST">
					@csrf
					@error('nombre')
		...
		<div class="col card-especie-grid ml-3 border-style"> <!--Grid -->
			<div class="row row-list border-bottom">
				<div class="col title-header">Lista Diagnósticos de Palpaciones</div>
				<div class="col">{{$diagnostico_palpaciones->links()}}</div>
			</div>
			...
			<table class="table table-especie">
	  			...
	  			@foreach ($diagnostico_palpaciones as $item)
		    		<tr>
				      ...
				      <td>
				      	<a href="{{ route('diagnostico_palpaciones.editar',[$finca->id_finca, $item->id_diagnostico]) }}" class="btn alert-success btn-sm">
