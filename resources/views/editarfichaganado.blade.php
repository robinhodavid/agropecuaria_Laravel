...
<div class="container">
	<div class="row mb-2">
		<div class="col border-top border-right border-left border-bottom card-parametros-peso">
			<div class="row">
				<div class="col-3">
					<label class="col-form-label">Parámetros de pesos:</label>
				</div>
				<div class="col-9">
				<a href="#" class="enlace my-2  float-right" ><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-earmark-check" viewBox="0 0 16 16">
		...
		<div class="col col-sm-5 border-top border-right border-left border-bottom card-parametros-tipo ">
		<div class="row">
            <label class="col-form-label">Parámetros Tipológicos:</label>
                <div class="col-mini-siderbar label-activo">
                  <div class="form-check form-switch">
                    <input 
                    class="form-check-input"
...
<div class="container">
	<div class="row border-top border-right border-left border-bottom card-ascendencia">
		<div class="row my-3">
			<label class="col-form-label">Ascendecia:</label>
			<!--Hijo -->
			<div class="col">
