    ...
    <div class="col-md-12"> <!-- Col1 -->
      <div class="card">
        <div class="card-header">
          <h3 class="card-title title-header">Editar Usuario</h3>
        </div>
        @if(session('msj'))
          ...
          <div class="row">
            ...
            <div class="col">
              ...
              <div class="form-check">
                ...
                @if( is_array(old('idfinca')) && in_array("$item->id_finca", old('idfinca')) )
                checked
                @elseif( is_array($sgfinca_user) && in_array("$item->id_finca", $sgfinca_user) )
                checked
                @endif
                >
