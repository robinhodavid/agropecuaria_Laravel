		...
		<div class="col card-especie mr-3 border-style"> <!--Form y Validación-->
			...
			<div class="row my-4">
				...
				@method('PUT')
						...
						<a href="{{ route('fincas') }}" class="btn btn-warning aling-boton"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-left-square" viewBox="0 0 16 16">
