...
<html lang="">
    <head>
        ...
        <title>Reporte Catálogo Series (Hembras) En Capacidad Reproductivas</title>
    ...
    <body>
        <div>
            ...
            <div>
                <label class="title-report-name">Reporte: Series (Hembras) En Capacidad Reproducticas</label>
