...
<div class="container">
	...
	<form method="GET" action="{{route('vistacomparar', $finca->id_finca)}}" role="search" class="form-trans">    
		...
		<form method="GET" action="{{route('imprimircomparar', $finca->id_finca)}}" role="search" class="form-trans" target="_blank">  
			@csrf		
			...
			<div class="row mr-4 ml-4">
				...
				<div class="col-md-6"> <!-- Col1 -->
					<div class="card">
						...
						@endif
						<label class="col-form-label oculto">tcab:</label>
						<input 
						...
						<div class="form-check oculto">
							@foreach($arregloSNp as $item)
							<input     				
							class="form-check-input oculto" 
							type="checkbox" 
							value="{{$item}}" id="serie"
							name="serie[]" checked="true"
							>
							@endforeach()

						</div>
						<div class="form-check oculto">
							@foreach($arregloPAnB as $item)
							<input     				
							class="form-check-input oculto" 
							type="checkbox" 
							value="{{$item}}" id="idserie"
							name="idserie[]" checked="true"
							>
							@endforeach()
						...
						<!-- /.card-body -->
						<div class="card-footer clearfix">
							<button type="submit" class="btn alert-success float-right" name="prin"value="1">
					...
					<div class="col-md-6 "> <!-- Col1 -->
						<div class="card">
							...
							<!-- /.card-body -->
							<div class="card-footer clearfix">
								<button type="submit" class="btn alert-success float-right" name="prin"value="2">
									<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-printer" viewBox="0 0 16 16">
										<path d="M2.5 8a.5.5 0 1 0 0-1 .5.5 0 0 0 0 1z"/>
										<path d="M5 1a2 2 0 0 0-2 2v2H2a2 2 0 0 0-2 2v3a2 2 0 0 0 2 2h1v1a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2v-1h1a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-1V3a2 2 0 0 0-2-2H5zM4 3a1 1 0 0 1 1-1h6a1 1 0 0 1 1 1v2H4V3zm1 5a2 2 0 0 0-2 2v1H2a1 1 0 0 1-1-1V7a1 1 0 0 1 1-1h12a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1h-1v-1a2 2 0 0 0-2-2H5zm7 2v3a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1v-3a1 1 0 0 1 1-1h6a1 1 0 0 1 1 1z"/>
									</svg></button>
						...
						<div class="col-md-6"> <!-- Col1 -->
							<div class="card">
								...
								<!-- /.card-body -->
								<div class="card-footer clearfix">
									<button type="submit" class="btn alert-success float-right" name="prin"value="3">
										<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-printer" viewBox="0 0 16 16">
											<path d="M2.5 8a.5.5 0 1 0 0-1 .5.5 0 0 0 0 1z"/>
											<path d="M5 1a2 2 0 0 0-2 2v2H2a2 2 0 0 0-2 2v3a2 2 0 0 0 2 2h1v1a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2v-1h1a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-1V3a2 2 0 0 0-2-2H5zM4 3a1 1 0 0 1 1-1h6a1 1 0 0 1 1 1v2H4V3zm1 5a2 2 0 0 0-2 2v1H2a1 1 0 0 1-1-1V7a1 1 0 0 1 1-1h12a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1h-1v-1a2 2 0 0 0-2-2H5zm7 2v3a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1v-3a1 1 0 0 1 1-1h6a1 1 0 0 1 1 1z"/>
										</svg></button>
