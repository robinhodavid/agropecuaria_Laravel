    		...
    		<div role="tabpanel">
			    <ul class="nav nav-tabs" role="tablist">
			      <li class="nav-item title-tipo" role="presentation">
			        <a class="nav-link active" href="#seccion3" arial-controls="seccion2" arial-controls="" data-toggle="tab" role="tab">Producción Lechera</a>
			      </li>
			    </ul>
    			<div class="tab-content">
      				<div class="tab-pane active" role="tabpanel" id="seccion3">
      					<form action="{{ route('parametros_produccion_leche.update',[ $finca->id_finca, $parametrosProduccion->id]) }}" method="POST" class="form-trans">
      					@method('PUT')	
	     				@csrf	
							...
							<div class="row">
								<div class="col">
									...
									<input 
					              	...
					              	placeholder="0"
					              	name="diassecado"
					              	value="{{$parametrosProduccion->diassecado}}"
					              	>
								</div>
								<div class="col">
									<label class="col-form-label title-tipo">Días de Lactancia Estimada: </label>
					              	...
					              	placeholder="0"
					              	value="{{$parametrosProduccion->diaslactanciaestimada}}"
					              	>
								</div>
								<div class="col">
									<label class="col-form-label title-tipo">Días de Producción al Mes: </label>
					              	...
					              	value="{{$parametrosProduccion->diasproducionalmes}}"
					              	>	
								</div>
							</div>
							<div class="row my-2">
								<div class="col">
									<label class="col-form-label title-tipo">Lactancia Ajustada (Días):  </label>
					              	...
					              	value="{{$parametrosProduccion->lactanciaajustada }}"
					              	>	
								</div>
								<div class="col">
									<label class="col-form-label title-tipo">Litros Promedio por Día:</label>
					              	...
					              	value="{{$parametrosProduccion->litrospromedioaldia}}"
					              	>
								</div>
								<div class="col">
									<label class="col-form-label title-tipo">Producción Ideal (Lts): </label>
					              	...
					              	value="{{$parametrosProduccion->produccionideal}}">
								</div>
							</div>
							<div class="row">
			                  ...
			                  <tbody>
			                    <tr>
			                      <td style="text-align: center;">
			                      	{{ $parametrosProduccion->diassecado }}
			                      </td>
			                      <td style="text-align: center;">
			                        {{ $parametrosProduccion->diaslactanciaestimada }}
			                      </td>
			                      <td style="text-align: center;">
			                      	{{ $parametrosProduccion->diasproducionalmes }}
			                      </td>
			                      <td style="text-align: center;">
			                      	{{ $parametrosProduccion->lactanciaajustada }}
			                      </td>
			                      <td style="text-align: center;">
			                      	{{ $parametrosProduccion->litrospromedioaldia }}
			                      </td>
			                      <td style="text-align: center;">
			                      	{{ $parametrosProduccion->produccionideal  }}
			                      </td>
			                    </tr>
			                  </tbody>
			            	</table>
