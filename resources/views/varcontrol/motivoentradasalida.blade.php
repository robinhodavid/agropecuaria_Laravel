		...
		<div class="col-md-6"> <!-- Col1 -->
			<div class="card">
	              	<div class="card-header">
	                	<div class="col title-header">Registro de Motivos: Entrada/Salida</div>
	              	</div>
	              	@if(session('msj'))
		            ...
		            <div class="card-body">
		            	<div class="form-registro">
		          			<form action="{{ route ('motivo_entrada_salida.crear', $finca->id_finca) }}" method="POST">
						    @csrf
						    @error('nombremotivo')
                 	...
                 	<div class="col title-header">Lista Motivos: Entrada/Salida</div>
	              	...
	              	<div class="card-body">
	              		<table class="table table-especie">
				          	<thead>
					            <tr>
					              <th scope="col" style="width: 49%;">Motivo</th>
					              <th scope="col">Ntura</th>
				            ...
				            <tr>
				              ...
				              <td>
				              <a href="{{route ('motivo_entrada_salida.editar', [$finca->id_finca, $item->id]) }}" class="btn alert-success btn-sm">
				              ...
				              <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
				                ...
				                <form action="{{ route ('motivo_entrada_salida.eliminar', [$finca->id_finca, $item->id]) }}" class="d-inline form-delete" method="POST">
				                @method('DELETE')
				                @csrf
	              	...
	              	<!-- /.card-body -->
	              	<div class="card-footer clearfix">
	                 	<div class="col">{{$motivo_entrada_salida->links()}}</div> 
	              	</div>
	        </div> <!--Col2 -->
		</div>
	</div>
