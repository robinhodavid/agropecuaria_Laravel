		...
		<div class="col-md-6"> <!-- Col1 -->
			<div class="card">
	              	<div class="card-header">
	                	<div class="col title-header">Editar Causa Muerte</div>
	              	</div>
	              	@if(session('msj'))
		            ...
		            <div class="card-body">
	            		<div class="form-registro">
          					<form action="{{ route ('destinosalida.update',[ $finca->id_finca, $destinosalida->id]) }}" method="POST">
          					@method('PUT')	
				            @csrf
				            @error('nombre')
