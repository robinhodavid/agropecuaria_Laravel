...
<div class="container">
	<div class="row">
		<div class="col-md-6"> <!-- Col1 -->
			<div class="card">
	              	<div class="card-header">
	                	<div class="col title-header">Editar Sala de Ordeño</div>
	              	</div>
	              	@if(session('msj'))
		            ...
		            <div class="card-body">
	            		<div class="form-registro">
          					<form action="{{ route ('salaordeno.update',[ $finca->id_finca, $salaordeno->id]) }}" method="POST">
          					@method('PUT')	
				            @csrf
				            @error('nombre')
		...
		<div class="col-md-6">
			<div class="card">
	           	<div class="card-header">
	                <div class="col title-header border-bottom">Listado Salas de Ordeño </div>
	            </div>
	            <!-- /.card-header -->
	            <div class="card-body">
