...
<div class="container">
    <ul class="nav nav-tabs">
      <li class="nav-item">
        <a class="nav-link active title-table" aria-current="page" href="#">Abortos Registrados
...
<form method="POST" action="{{ route('print_abortos', $finca->id_finca) }}" role="search" target="_blank" class="form-trans">    
@csrf
    ...
    <div class="col column-space">
      <div class="row">
        ...
        <div class="col my-4"> <!--Rango Fecha de Registro -->
          <label class="col-form-label title-filed">Causa de Aborto</label>
          <select class="form-select" aria-label="Default select example" name="causa">
            <option value ="" selected>Causa de Abortos</option>
        ...
        <div class="col" style="background-color: #eaeaea;"> <!--Rango Fecha de Registro -->
          <div class="row">
            <label class="title-filed" style="text-align: center;" >Fecha Aborto</label>
            <div class="col" style="text-align: center;" >
              ...
              <div class="input-group mb-2">
                <input 
                      ...
                      min="1980-01-01" 
                      max="2031-12-31"
                      aria-label="fadesde" aria-describedby="basic-addon2">
            ...
            <div class="col" style="text-align: center;">
              ...
              <div class="input-group mb-2">
                <input 
                      ...
                      min="1980-01-01" 
                      max="2031-12-31"
                      aria-label="fahasta" aria-describedby="basic-addon2">
                      <span class="input-group-text" id="basic-addon2"><i class="far fa-calendar-alt"></i></span>  
                </div>    
            </div>
          </div>
