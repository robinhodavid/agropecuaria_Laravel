...
<div class="container">
    <ul class="nav nav-tabs">
      <li class="nav-item">
        <a class="nav-link active title-table" aria-current="page" href="#">Historial de Salida
...
<form method="GET" action=" {{ route ('histsal.reporte', $finca->id_finca) }}" role="search" target="_blank" class="form-trans">    
@csrf
<div class="row my-2 mr-4 ml-4">
  <div class="col column-space">
    <div class="row">
      ...
      <div class="col">
        <label class="col-form-label title-filed">Motivo de Salida</label>
      ...
      <div class="col">
       <label class="col-form-label title-filed">Destino</label>
          <select class="form-select width-field" name="destino" aria-label="select example">
