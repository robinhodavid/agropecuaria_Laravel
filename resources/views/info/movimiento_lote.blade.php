...
<div class="container">
    <ul class="nav nav-tabs">
      <li class="nav-item">
        <a class="nav-link active title-table" aria-current="page" href="#">Movimiento de Lotes
...
<form method="GET" action="{{ route ('movimientolote.reporte',$finca->id_finca) }}" role="search" target="_blank" class="form-trans">    
@csrf
    ...
    <div class="row">
      <div class="col">
        ...
        <label class="checkbox-inline title-label"  for="campo1">Serie</label>
          ...
          aria-label="Radio button for following text input"
          name="orderby"
          id="campo5" value="tipologiaactual">
