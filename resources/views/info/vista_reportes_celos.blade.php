...
<div class="container">
    <ul class="nav nav-tabs">
      <li class="nav-item">
        <a class="nav-link active title-table" aria-current="page" href="#">Celos Registrados
...
<form method="POST" action="{{ route('print_celos', $finca->id_finca) }}" role="search" target="_blank" class="form-trans">    
@csrf
    ...
    <div class="col column-space">
      <div class="row">
        ...
        <div class="col" style="background-color: #eaeaea;"> <!--Rango Fecha de Registro -->
          <div class="row">
            <label class="title-filed" style="text-align: center;" >Fecha Celo</label>
            <div class="col" style="text-align: center;" >
              ...
              <div class="input-group mb-2">
                <input 
                      ...
                      min="1980-01-01" 
                      max="2031-12-31"
                      aria-label="fcdesde" aria-describedby="basic-addon2">
            ...
            <div class="col" style="text-align: center;">
              ...
              <div class="input-group mb-2">
                <input 
                      ...
                      min="1980-01-01" 
                      max="2031-12-31"
                      aria-label="fchasta" aria-describedby="basic-addon2">
                      <span class="input-group-text" id="basic-addon2"><i class="far fa-calendar-alt"></i></span>  
                </div>    
            </div>
          </div>
          ...
          <div class="col">
            <h6><strong>Ordenar por:</strong></h6> 
              <div class="col">
                ...
                aria-label="Radio button for following text input"
                name="orderby"
                id="campo2" value="fechr">
                <label class="checkbox-inline title-label"  for="campo2">Fecha de Registro</label>
              </div>
          </div>
          <div class="col">
