...
<div class="container">
    <ul class="nav nav-tabs">
      <li class="nav-item">
        <a class="nav-link active title-table" aria-current="page" href="#">Servicios Registrados
...
<form method="POST" action="{{ route('print_servicios', $finca->id_finca) }}" role="search" target="_blank" class="form-trans">    
@csrf
