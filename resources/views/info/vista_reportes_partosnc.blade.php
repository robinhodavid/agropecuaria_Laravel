...
<div class="container">
    <ul class="nav nav-tabs">
      <li class="nav-item">
        <a class="nav-link active title-table" aria-current="page" href="#">Registros Partos No Culminados 
...
<form method="POST" action="{{ route('print_partosnc', $finca->id_finca) }}" role="search" target="_blank" class="form-trans">    
@csrf
  <div class="row my-2 mr-4 ml-4">
    <div class="col column-space">
      <div class="row">
        ...
        <div class="col my-4"> <!--Rango Fecha de Registro -->
          <label class="col-form-label title-filed">Causa</label>
          <select class="form-select" aria-label="Default select example" name="causa">
            <option value ="" selected>Causa</option>
        ...
        <div class="col" style="background-color: #eaeaea;"> <!--Rango Fecha de Registro -->
          <div class="row">
            <label class="title-filed" style="text-align: center;" >Fecha Parto No Culminado</label>
            <div class="col" style="text-align: center;" >
              ...
              <div class="input-group mb-2">
                <input 
                      ...
                      min="1980-01-01" 
                      max="2031-12-31"
                      aria-label="fpncdesde" aria-describedby="basic-addon2">
            ...
            <div class="col" style="text-align: center;">
              ...
              <div class="input-group mb-2">
                <input 
                      ...
                      min="1980-01-01" 
                      max="2031-12-31"
                      aria-label="fpnchasta" aria-describedby="basic-addon2">
                      <span class="input-group-text" id="basic-addon2"><i class="far fa-calendar-alt"></i></span>  
                </div>    
            </div>
          </div>
          ...
          <div class="col">
            <h6><strong>Ordenar por:</strong></h6> 
              <div class="col">
                ...
                aria-label="Radio button for following text input"
                name="orderby"
                id="campo2" value="fecregistro">
                <label class="checkbox-inline title-label"  for="campo2">Fecha de Aborto</label>
                <input 
                type="radio"  
                aria-label="Radio button for following text input"
                name="orderby"
                id="campo3" value="causa">
                <label class="checkbox-inline title-label"  for="campo2">Causa</label>
              </div>
          </div>
          <div class="col">
