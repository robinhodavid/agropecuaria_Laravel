...
<div class="row mb-2">
	<div class="col">
		<a href="{{ route('catalogodeganado.reporte', $finca->id_finca) }}" target="_blank" class="btn btn-default float-right"><i class="fas fa-print"></i></a>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Series Activas</h3>
                <div class="card-tools">
	                <form method="GET" action="{{route('series_activas',$finca->id_finca) }}" role="search">
