...
<div class="container">
	<div class="row">
		<div class="col-5 card-especie mr-3 border-style"> <!--Form y Validación-->
			<div class="row row-list border-bottom">
				<div class="col title-header">Registro Condición Corporal</div>
			</div>
			 @if(session('msj'))
			...
			<div class="row my-4">
				<div class="form-registro">
					<form action="{{ route('condicion_corporal.crear', $finca->id_finca) }}" method="POST">
					@csrf
					@error('nombre')
		...
		<div class="col card-especie-grid ml-3 border-style"> <!--Grid -->
			<div class="row row-list border-bottom">
				<div class="col title-header">Listado Condiciones Corporales</div>
			</div>
			<div class="col">{{$condicion_corporal->links()}}</div>	
	  			...
	  			<tbody>
	  			 @foreach ($condicion_corporal as $item)
		    		<tr>
				      ...
				      <td>
				      	<a href="{{ route('condicion_corporal.editar', [$finca->id_finca, $item->id_condicion]) }}" class="btn alert-success btn-sm">
				      	...
				      	<form action="{{ route('condicion_corporal.eliminar', [$finca->id_finca, $item->id_condicion]) }}" class="d-inline" method="POST">
						    @method('DELETE')
						    @csrf
