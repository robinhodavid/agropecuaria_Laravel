		...
		<div class="col-md-12"> <!-- Col1 -->
			<div class="card">
	              	<div class="card-header">
	                	<div class="col title-header">Ficha de Pajuela Pajuela</div>
	              	</div>
	              	@if(session('msj'))
	              ...
	              <div class="card-body">
	              	<div class="row">
	              		<div class="col-md-6">
	              			<div class="col title-header">Registro de Pajuela Pajuela</div>
            ...
            @foreach($pajuela as $item)
              ...
              {{ $item->nombreraza }}         
                ...
                <td>
                    ...
                    <form action="{{ route ('pajuela.eliminar', [$finca->id_finca, $item->id]) }}" class="d-inline form-delete" method="POST">
                      @method('DELETE')
                      @csrf
