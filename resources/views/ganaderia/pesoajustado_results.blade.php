...
<div class="container">
    <ul class="nav nav-tabs">
      <li class="nav-item">
        <a class="nav-link active title-table" aria-current="page" href="#">Resultado de Ajustado
 ...
 <!-- Fin de Form para busqueda  -->           
</div>
<form method="GET" action="{{ route('pesoajustado.reporte', $finca->id_finca) }}" role="search"  target="_blank" class="form-trans"> 
 @csrf
    <div class="table">
          <table class="table">
            <thead class="title-table">
              <tr>
                ...
                <th scope="col" style="text-align: center;">ind (%)</th>
           ...
           @endforeach() 
            ...
            <thead class="title-table">
              <tr>
                ...
                <th scope="col" style="text-align: center;">Promedios</th>
                <th scope="col" style="text-align: center;">{{$promPesoDestete}}</th>
                <th scope="col" style="text-align: center;">{{$promPa1}}</th>
                <th scope="col" style="text-align: center;"></th>
  ...
  <div class="card-footer clearfix my-4">
    <div class="row">
      <div class="col">
        ...
        <a href="{{ route('peso_ajustado',$finca->id_finca) }}" class="btn btn-warning aling-boton"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-left-square" viewBox="0 0 16 16">
