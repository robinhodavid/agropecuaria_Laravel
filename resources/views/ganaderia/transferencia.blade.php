    ...
    <div class="col-md-12"> <!-- Col1 -->
      <div class="card">
          <div class="card-header">
            <h3 class="card-title title-header">Transferencia de Series</h3>
          ...
          <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="row">
                  <div class="col-4">
                    <label class="col-form-label">Fec. Transferencia:
                    </label>
                  ...
                  <div class="col-4">
                    ...
                    <select class="form-select" name="motivo" aria-label="select example">
                        ...
                        <option value="{{ $item->id}}" selected> {{ $item->nombremotivo }} ({{ $item->nomenclatura }})
                        </option>
                        @endforeach()
                    </select>    
                  </div>
                  <div class="col-4 ">
                    <label class="col-form-label">Finca Destino:</label>
